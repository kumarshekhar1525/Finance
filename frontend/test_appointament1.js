...
async function testAppointament1Insert() {
  console.log('Testing insert into appointament1 table with clean serial ID and photo details...');
  ...
  if (error) {
    ...
    console.log('Success! Inserted row in appointament1:', JSON.stringify(data, null, 2));
  }
}
