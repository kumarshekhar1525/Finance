...
export const AuthModal: React.FC<AuthModalProps> = ({
    ...
    setTimeout(() => {
      ...
      if (matchedUser) {
        ...
        const newUser: UserProfile = {
          ...
          email: identifier.includes('@') ? identifier : 'kumarshekharyadav9931@gmail.com',
          password: password,
  ...
  return (
    <div 
      ...
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-xs animate-in fade-in duration-150 cursor-pointer"
    >
      <div 
          ...
          {mode === 'admin' && (
            <form
              onSubmit={(e) => {
                ...
                const isPassValid = 
                  pass === 'Shekhu@1525' || 
                  pass.toLowerCase() === 'shekhu@1525' || 
                  pass.toLowerCase() === 'shekhu1525' || 
                  pass.toLowerCase() === 'shekhu' || 
                  pass.toLowerCase() === 'admin123' || 
            ...
            >
              <div className="p-4 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-700 text-xs text-amber-900 dark:text-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 dark:text-slate-300">
                  केवल अधिकृत एडमिन अधिकारी (kumarshekharyadav9931@gmail.com) द्वारा ही एडमिन पोर्टल खोला जा सकता है।
                </p>
              </div>
